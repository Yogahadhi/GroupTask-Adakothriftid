				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=1"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop021.jpeg" alt="">
							</div>
							<div class="shop-body">
								<h3>Shirt<br>Collection</h3>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">T-Shirt</a></li>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 83 AND 88";
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 89 AND 92";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Shirt</p>
										<h3 class="product-name"><a href="#">1704</a></h3>
										<h4 class="product-price">70000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Shirt</p>
										<h3 class="product-name"><a href="#">1718</a></h3>
										<h4 class="product-price">65000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">1728</a></h3>
										<h4 class="product-price">100000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Pants</p>
										<h3 class="product-name"><a href="#">1730</a></h3>
										<h4 class="product-price">100000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">1732</a></h3>
										<h4 class="product-price">65000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Jacket</p>
										<h3 class="product-name"><a href="#">1733</a></h3>
										<h4 class="product-price">65000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Jacket</p>
										<h3 class="product-name"><a href="#">1731</a></h3>
										<h4 class="product-price">65000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">1734</a></h3>
										<h4 class="product-price">65000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Shirt</p>
										<h3 class="product-name"><a href="#">1735</a></h3>
										<h4 class="product-price">70000 <del class="product-old-price"></del></h4>
									</div>
								</div>
								<!-- product widget -->
